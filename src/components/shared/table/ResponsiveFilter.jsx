    ...
    <>
      <Button
        ...
        className={clsx(
          ...
          open
            ? "border-primary-600 ring-primary-500/50 dark:border-primary-500 ring-0"
            : "border-dashed",
          classNames?.button,
        )}
        onClick={open}
      ...
      {({ open }) => (
        <>
          ...
          <Transition
            ...
            anchor={anchor}
            className="ring-primary-500/50 dark:border-dark-500 dark:bg-dark-750 z-10 flex w-fit flex-col rounded-md border border-gray-300 bg-white shadow-lg shadow-gray-200/50 outline-hidden focus-visible:ring-3 focus-visible:outline-hidden dark:shadow-none"
          >
